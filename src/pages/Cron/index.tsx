                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      schedule === preset.value
                        ? "bg-primary hover:bg-primary/90 text-primary-foreground dark:bg-white dark:text-black dark:hover:bg-white/90 shadow-sm border-transparent"
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button
                ...
                className={cn(
                  ...
                  deliveryMode === 'none'
                    ? 'bg-primary hover:bg-primary/90 text-primary-foreground dark:bg-white dark:text-black dark:hover:bg-white/90 border-transparent'
                    : 'bg-white dark:bg-muted border-black/10 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/5 text-foreground/80 hover:text-foreground',
                )}
              >
                <div>
...
function CronJobCard({ job, deliveryAccountName, onToggle, onEdit, onDelete, onTrigger }: CronJobCardProps) {
  ...
  return (
    <div
      className="group flex flex-col p-5 rounded-2xl bg-transparent border border-black/5 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/5 transition-all relative overflow-hidden cursor-pointer"
      onClick={onEdit}
    >
