    ...
    <div data-testid="models-page" className="flex flex-col -m-6 dark:bg-background h-[calc(100vh-2.5rem)] overflow-hidden">
      <div className="w-full max-w-5xl mx-auto flex flex-col h-full p-10 pt-16">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between mb-12 shrink-0 gap-4">
          <div>
            <h1 data-testid="models-page-title" className="mb-3 text-4xl font-normal tracking-tight text-foreground md:text-5xl" style={{ fontFamily: 'Georgia, Cambria, "Times New Roman", Times, serif' }}>
