...
### 🗂️ 内置 Agents 市场
Agents 页面默认进入离线市场，内置来自 The Agency / `msitarzewski/agency-agents` 固定快照（`783f6a7`）的 184 个模板，并按 14 个一级分类浏览。模板随安装包提供，运行时不会访问 GitHub；点击添加时才懒加载详情并转换为 OpenClaw 工作区文件（`SOUL.md`、`AGENTS.md`、`IDENTITY.md`）。
