...
if /i "%1"=="update" (
    echo openclaw is managed by SpriteClaw ^(bundled version^).
    echo.
    echo To update openclaw, update SpriteClaw:
    echo   Open SpriteClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=SpriteClaw
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\SpriteClaw.exe" "%OPENCLAW_ENTRY%" %*
)
