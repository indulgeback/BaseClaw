...
if /i "%1"=="update" (
    echo openclaw is managed by PokeClaw ^(bundled version^).
    echo.
    echo To update openclaw, update PokeClaw:
    echo   Open PokeClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=PokeClaw
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\PokeClaw.exe" "%OPENCLAW_ENTRY%" %*
)
